...
describe('EnGalleryDetailComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [ EnGalleryDetailComponent, FormBuilder ],
      imports: [HttpClientTestingModule, RouterTestingModule]
    });
    httpTestingController = TestBed.inject(HttpTestingController);
    component = TestBed.inject(EnGalleryDetailComponent);
  });
  ...
  it('Should make the API request to get detailed information of picture', () => {
    ...
    const req = httpTestingController.expectOne('https://valoukervyn.ephec-ti.be:8888/api/galerie/splash');
  ...
  it('Should make get request for gallery comments', () => {
    component.nbrUrl = 2;
    component.comment();
    const req = httpTestingController.expectOne('https://valoukervyn.ephec-ti.be:8888/api/commentsgallery/2');
    expect(req.request.method).toEqual('GET');
  });

  it('Should do a post request to backend for new comments', () => {
    const url = `https://valoukervyn.ephec-ti.be:8888/api/commentsgallery?user=1&painting=2&comment=testing%20comment`;
